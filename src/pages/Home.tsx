      ...
      <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              <Feature>
                <div className="flex flex-col items-center text-center">
                  ...
                  <p>View and filter through 1300+ exercises with demonstrations</p>
                </div>
              </Feature>
              <Feature>
                <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap justify-around px-4">
            {questions.map(q => (
              <div className="w-full sm:w-1/2 lg:w-1/4 p-4 text-white" key={q.id}>
                <div onClick={() => setOpenQuestion(openQuestion === q.id ? null : q.id)} className="cursor-pointer flex justify-between items-center">
        ...
        <footer className="w-full py-10 bg-white flex flex-col items-center justify-center">
          ...
          <div className="flex space-x-4">
            ...
            />
            <button className="bg-gradient-to-r from-custom-red-1 via-custom-red-2 to-custom-red-1 text-white font-semibold py-2 px-4 rounded-md shadow-md">
              Subscribe
            </button>
          </div>
          <div className='flex items-center justify-center mt-5'>
            Image by <a href="https://www.freepik.com/free-vector/gradient-home-gym-with-different-elements_11827840.htm#query=exercise%20room&position=0&from_view=keyword&track=ais">Freepik</a>
          </div>
        </footer>
      </div>
    </div>
