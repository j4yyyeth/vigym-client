  ...
  return (
    <div className="flex mt-12">
      <div className="m-4 bg-white bg-opacity-30 rounded p-4">
        <Link className="bg-white shadow-md rounded-md p-4 text-blue-500 px-4 py-2 text-center block" to={'/create-workout'}>Create a Workout</Link>
        <div>
          <label className="block text-sm text-gray-800 mt-2">Filter by number of exercises:</label>
